...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_SEND_TXT) {
            ...
            return new ReceiveTextHolder(parent.getContext(), conversation,parent, onRecyclerViewListener);
        } else if (viewType == TYPE_RECEIVER_IMAGE) {
            return new ReceiveImageHolder(parent.getContext(), conversation,parent, onRecyclerViewListener);
        } else if (viewType == TYPE_RECEIVER_LOCATION) {
            return new ReceiveLocationHolder(parent.getContext(), conversation,parent, onRecyclerViewListener);
        } else if (viewType == TYPE_RECEIVER_VOICE) {
            return new ReceiveVoiceHolder(parent.getContext(),conversation, parent, onRecyclerViewListener);
        } else if (viewType == TYPE_RECEIVER_VIDEO) {
            return new ReceiveVideoHolder(parent.getContext(),conversation, parent, onRecyclerViewListener);
